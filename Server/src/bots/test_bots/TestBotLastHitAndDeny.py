...
class TestBotLastHitAndDeny(BaseBot):
    '''
    Tests:
    - All heroes should prioritize getting last hits and then getting denies.
    - Test is successful if most heroes have more last hits than denies.
    '''
