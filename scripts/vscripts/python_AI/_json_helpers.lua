...
--[[ THIS END GAMES ON FIRST TOWER KILL - SO WE NEED TO DO SOMETHING LIKE THIS ]]
--[[ Instead of doing this,9 the info should be saved!  ]]
--[[ Things to do: 1) remove towers from the list after destroyed. 2) Store info about it. 3) check for inner turrets! ]]
function Dota2AI:CheckTurretsEnemies()
    local towers = {         
        "dota_badguys_tower1_bot",
        "dota_badguys_tower1_mid",
        "dota_badguys_tower1_top",
